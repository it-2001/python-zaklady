...
x = 0
# global = 1 - global - použito klíčové slovo
global1 = 1
PI = 3.14
city = "Opava"
# hilda@sspu-opava.cz = 'Hilda Dokonalá' - nesmí obsahovat znaky typu např. [!@#$%] a pomlčky
hildaZavinacSspu_Opava_cz = 'Hilda Dokonalá'
