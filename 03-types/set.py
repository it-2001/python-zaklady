...
Sada je kolekce, která je neuspořádaná a neindexovaná.
 V Pythonu jsou sady psány se složenými závorkami.
'''
my_set = {2, 3, 9, 7}
...
# K položkám v sadě nemůžete přistupovat odkazem na rejstřík, protože sady nejsou seřazeny, položky nemají žádný rejstřík.
# my_set[1]
